`ifndef ALGN_VIRTUAL_SEQUENCE_REG_ACCESS_RANDOM_SV
  `define ALGN_VIRTUAL_SEQUENCE_REG_ACCESS_RANDOM_SV
  ...
  class algn_virtual_sequence_reg_access_random extends algn_virtual_sequence_base;
    ...
    function new(string name = "algn_virtual_sequence_reg_access_random");
      super.new(name);
    endfunction
