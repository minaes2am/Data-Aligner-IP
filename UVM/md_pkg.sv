`ifndef MD_PKG_SV
  ...
  package md_pkg;
    ...
    class md_agent_config#(int unsigned DATA_WIDTH = 32) extends uvm_ext_agent_config#(.VIRTUAL_INTF(virtual md_if#(DATA_WIDTH)));
      ...
      function new(string name = "md_agent_config", uvm_component parent);
    ...
    class md_agent_config_slave#(int unsigned DATA_WIDTH = 32) extends md_agent_config#(DATA_WIDTH);
      ...
      function new(string name = "md_agent_config_slave", uvm_component parent);
        super.new(name, parent);
    ...
    class md_agent_config_master#(int unsigned DATA_WIDTH = 32) extends md_agent_config#(DATA_WIDTH);
      ...
      function new(string name = "md_agent_config_master", uvm_component parent);
        super.new(name, parent);
      endfunction
    ...
    class md_monitor#(int unsigned DATA_WIDTH = 32) extends uvm_ext_monitor#(.VIRTUAL_INTF(virtual md_if#(DATA_WIDTH)), .ITEM_MON(md_item_mon));
      ...
      function new(string name = "md_monitor", uvm_component parent);
        super.new(name, parent);
      endfunction
    ...
    class md_coverage#(int unsigned DATA_WIDTH = 32) extends uvm_ext_coverage#(.VIRTUAL_INTF(virtual md_if#(DATA_WIDTH)), .ITEM_MON(md_item_mon));
      ...
      covergroup cover_item with function sample(md_item_mon item);
        ...
        length : coverpoint item.length {
          option.comment = "Length of the MD access. For RX (master) the DUT slave only back-pressures when RX FIFO is full, which is structurally unreachable in normal test runs. For TX (slave) the testbench drives length=1..10 via round-robin but length>10 never occurs.";
          bins length_eq_1     = {1};

          illegal_bins length_lt_1           = {0};
          ignore_bins  length_le_10_rx_only  = {[2:10]};
      ...
      covergroup cover_reset with function sample(bit valid);
        ...
        access_ongoing : coverpoint valid {
          ...
          ignore_bins access_ongoing_unreachable = {1};
        }
      endgroup

      function new(string name = "md_coverage", uvm_component parent);
        super.new(name, parent);
    ...
    class md_sequencer_base#(type ITEM_DRV = md_item_drv) extends uvm_ext_sequencer#(.ITEM_DRV(ITEM_DRV));
      ...
      function new(string name = "md_sequencer_base", uvm_component parent);
        super.new(name, parent);
      endfunction
  ...
  class md_sequencer_base_master extends md_sequencer_base#(.ITEM_DRV(md_item_drv_master));
    ...
    function new(string name = "md_sequencer_base_master", uvm_component parent);
      super.new(name, parent);
    endfunction
  endclass
  ...
  class md_sequencer_master#(int unsigned DATA_WIDTH = 32) extends md_sequencer_base_master;
    ...
    function new(string name = "md_sequencer_master", uvm_component parent);
      super.new(name, parent);
    endfunction
  ...
  class md_sequencer_base_slave extends md_sequencer_base#(.ITEM_DRV(md_item_drv_slave));
    ...
    function new(string name = "md_sequencer_base_slave", uvm_component parent);
      super.new(name, parent);
  ...
  class md_sequencer_slave#(int unsigned DATA_WIDTH = 32) extends md_sequencer_base_slave;
    ...
    function new(string name = "md_sequencer_slave", uvm_component parent);
      super.new(name, parent);
    endfunction
  ...
  class md_driver#(int unsigned DATA_WIDTH = 32, type ITEM_DRV = md_item_drv) extends uvm_ext_driver#(.VIRTUAL_INTF(virtual md_if#(DATA_WIDTH)), .ITEM_DRV(ITEM_DRV));

    //Pointer to agent configuration
    md_agent_config#(DATA_WIDTH) agent_config;

    `uvm_component_param_utils(md_driver#(DATA_WIDTH, ITEM_DRV))

    function new(string name = "md_driver", uvm_component parent);
      super.new(name, parent);
    endfunction
  ...
  class md_driver_master#(int unsigned DATA_WIDTH = 32) extends md_driver#(.DATA_WIDTH(DATA_WIDTH), .ITEM_DRV(md_item_drv_master));
    ...
    function new(string name = "md_driver_master", uvm_component parent);
      super.new(name, parent);
    endfunction

    //Task which drives one single item on the bus
    protected virtual task drive_transaction(md_item_drv_master item);
  ...
  class md_driver_slave#(int unsigned DATA_WIDTH = 32) extends md_driver#(.DATA_WIDTH(DATA_WIDTH), .ITEM_DRV(md_item_drv_slave));
    ...
    function new(string name = "md_driver_slave", uvm_component parent);
      super.new(name, parent);
    endfunction
  ...
  class md_agent#(int unsigned DATA_WIDTH = 32, type ITEM_DRV = md_item_drv) extends uvm_ext_agent#(.VIRTUAL_INTF(virtual md_if#(DATA_WIDTH)), .ITEM_MON(md_item_mon), .ITEM_DRV(ITEM_DRV));
    
    typedef virtual md_if#(DATA_WIDTH) md_vif;

    `uvm_component_param_utils(md_agent#(DATA_WIDTH, ITEM_DRV))

    function new(string name = "md_agent", uvm_component parent);
      super.new(name, parent);
      
      uvm_ext_agent_config#(.VIRTUAL_INTF(md_vif))::type_id::set_inst_override(md_agent_config#(DATA_WIDTH)::get_type(), "agent_config", this);
      ...
      uvm_ext_driver#(.VIRTUAL_INTF(md_vif), .ITEM_DRV(ITEM_DRV))::type_id::set_inst_override(md_driver#(DATA_WIDTH, ITEM_DRV)::get_type(), "driver", this);
  ...
  class md_agent_slave#(int unsigned DATA_WIDTH = 32) extends md_agent#(DATA_WIDTH, md_item_drv_slave);
    ...
    function new(string name = "md_agent_slave", uvm_component parent);
      super.new(name, parent);
      
      md_agent_config#(DATA_WIDTH)::type_id::set_inst_override(md_agent_config_slave#(DATA_WIDTH)::get_type(), "agent_config", this);
      md_driver#(DATA_WIDTH, md_item_drv_slave)::type_id::set_inst_override(md_driver_slave#(DATA_WIDTH)::get_type(), "driver", this);
      md_sequencer_base#(md_item_drv_slave)::type_id::set_inst_override(md_sequencer_slave#(DATA_WIDTH)::get_type(), "sequencer", this);
    endfunction
  ...
  class md_agent_master#(int unsigned DATA_WIDTH = 32) extends md_agent#(DATA_WIDTH, md_item_drv_master);
    ...
    function new(string name = "md_agent_master", uvm_component parent);
      super.new(name, parent);
  ...
  class md_sequence_base_slave extends md_sequence_base#(.ITEM_DRV(md_item_drv_slave));
    ...
    `uvm_declare_p_sequencer(md_sequencer_base_slave)
  ...
  class md_sequence_base_master extends md_sequence_base#(.ITEM_DRV(md_item_drv_master));
    ...
    `uvm_declare_p_sequencer(md_sequencer_base_master)
  ...
  class md_sequence_simple_master extends md_sequence_base_master;
    ...
    function new(string name = "md_sequence_simple_master");
      super.new(name);
